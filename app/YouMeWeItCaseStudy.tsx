    ...
    <div className="project-body you-me-case-study">
      ...
      <section className="case-study-chapter case-study-context">
        <div className="case-study-copy">
          <span>01 / The quiet room</span>
          <h4>The social centre was still there. Its pulse was not.</h4>
      ...
      <blockquote className="case-study-question">
        <span>Design prompt</span>
        <p>Can the warmth of a drink reveal the social temperature of a room?</p>
      </blockquote>

      <section className="case-study-chapter case-study-concept">
        <figure><img src={`${CASE_ASSET}/thermal-signature.jpg`} alt="A luminous thermal signature generated by the installation" loading="lazy" /></figure>
        <div className="case-study-copy">
      ...
      <section className="case-study-visual-system">
        <div className="case-study-copy">
          <span>05 / Drawing social warmth</span>
      ...
      <section className="case-study-outcome">
        <header>
          <span>06 / Back into the room</span>
